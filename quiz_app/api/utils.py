...
def get_user_owned_quiz(quiz_id, user):
	"""
	Get a quiz ensuring the user owns it.
	...
	Raises:
		QuizNotFound: If quiz doesn't exist
		QuizAccessDenied: If user doesn't own the quiz
		
	Returns:
		Quiz instance with prefetched questions
	"""
...
def quiz_error_response(exception):
	"""
	Convert quiz exceptions to DRF Response objects.
	
	Args:
		exception: QuizNotFound or QuizAccessDenied instance
